...
help_coc_detailed() {
  case "$1" in
    coc)
      ...
      echo "  vcfg coc show                    # Show all extensions with details"
      echo "  vcfg coc show <number>           # Show first N extensions"
      echo "  vcfg coc show <start> <end>      # Show extensions from row start to end"
